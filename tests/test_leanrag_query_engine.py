...
from heta_framework.common.stores import InMemoryGraphStore, InMemoryVectorStore, SQLStore  # noqa: E402
...
async def _build_context(*, with_language=True):
    ...
    recipe = KnowledgeRecipe(
        ...
        stores=KnowledgeStores(graph=graph, sql=sql, vector=vector),
    )
